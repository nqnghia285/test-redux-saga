...
export namespace Prisma {
  ...
  */
  ...
  export type LaptopCountOutputTypeGetPayload<
    ...
    ? {
    [P in TrueKeys<S['select']>]:
    P extends keyof LaptopCountOutputType ? LaptopCountOutputType[P] : never
  } 
    : LaptopCountOutputType
  : LaptopCountOutputType
  ...
  export type PriceMapCountOutputTypeGetPayload<
    ...
    ? {
    [P in TrueKeys<S['select']>]:
    P extends keyof PriceMapCountOutputType ? PriceMapCountOutputType[P] : never
  } 
    : PriceMapCountOutputType
  : PriceMapCountOutputType
  ...
  export type CustomerGetPayload<
    ...
    ? Customer  & {
    [P in TrueKeys<S['include']>]:
        P extends 'profile' ? PersonGetPayload<S['include'][P]> :
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'profile' ? PersonGetPayload<S['select'][P]> :
  ...
  type GetLaptopGroupByPayload<T extends LaptopGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type LaptopGetPayload<
    ...
    ? Laptop  & {
    [P in TrueKeys<S['include']>]:
        P extends 'priceMap' ? PriceMapGetPayload<S['include'][P]> | null :
        P extends 'discounts' ? Array < DiscountGetPayload<S['include'][P]>>  :
        P extends 'defaultImage' ? ImageGetPayload<S['include'][P]> | null :
        P extends 'purchases' ? Array < PurchaseGetPayload<S['include'][P]>>  :
        P extends 'posts' ? Array < PostGetPayload<S['include'][P]>>  :
        P extends 'comments' ? Array < CommentGetPayload<S['include'][P]>>  :
        P extends 'images' ? Array < ImageGetPayload<S['include'][P]>>  :
        P extends 'videos' ? Array < VideoGetPayload<S['include'][P]>>  :
        P extends '_count' ? LaptopCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'priceMap' ? PriceMapGetPayload<S['select'][P]> | null :
        P extends 'discounts' ? Array < DiscountGetPayload<S['select'][P]>>  :
        P extends 'defaultImage' ? ImageGetPayload<S['select'][P]> | null :
        P extends 'purchases' ? Array < PurchaseGetPayload<S['select'][P]>>  :
        P extends 'posts' ? Array < PostGetPayload<S['select'][P]>>  :
        P extends 'comments' ? Array < CommentGetPayload<S['select'][P]>>  :
        P extends 'images' ? Array < ImageGetPayload<S['select'][P]>>  :
        P extends 'videos' ? Array < VideoGetPayload<S['select'][P]>>  :
        P extends '_count' ? LaptopCountOutputTypeGetPayload<S['select'][P]> :  P extends keyof Laptop ? Laptop[P] : never
  } 
    : Laptop
  : Laptop
  ...
  export interface LaptopDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    >(args: SubsetIntersection<T, LaptopGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetLaptopGroupByPayload<T> : PrismaPromise<InputErrors>
  }
  ...
  export type CommentGetPayload<
    ...
    ? Comment  & {
    [P in TrueKeys<S['include']>]:
        P extends 'author' ? PersonGetPayload<S['include'][P]> :
        P extends 'laptop' ? LaptopGetPayload<S['include'][P]> :
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'author' ? PersonGetPayload<S['select'][P]> :
        P extends 'laptop' ? LaptopGetPayload<S['select'][P]> :
  ...
  type GetPriceMapGroupByPayload<T extends PriceMapGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type PriceMapGetPayload<
    ...
    ? PriceMap  & {
    [P in TrueKeys<S['include']>]:
        P extends 'laptops' ? Array < LaptopGetPayload<S['include'][P]>>  :
        P extends '_count' ? PriceMapCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'laptops' ? Array < LaptopGetPayload<S['select'][P]>>  :
        P extends '_count' ? PriceMapCountOutputTypeGetPayload<S['select'][P]> :  P extends keyof PriceMap ? PriceMap[P] : never
  } 
    : PriceMap
  : PriceMap
  ...
  export interface PriceMapDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    >(args: SubsetIntersection<T, PriceMapGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPriceMapGroupByPayload<T> : PrismaPromise<InputErrors>
  }
  ...
  export type PriceMapCreateManyArgs = {
    /**
     * The data used to create many PriceMaps.
     * 
    **/
  ...
  export type PriceMapDeleteManyArgs = {
    /**
     * Filter which PriceMaps to delete
     * 
    **/
    where?: PriceMapWhereInput
  }
  ...
  type GetPassageGroupByPayload<T extends PassageGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type PassageGetPayload<
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'post' ? PostGetPayload<S['select'][P]> :  P extends keyof Passage ? Passage[P] : never
  } 
    : Passage
  : Passage
  ...
  export interface PassageDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    >(args: SubsetIntersection<T, PassageGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPassageGroupByPayload<T> : PrismaPromise<InputErrors>
  }
  ...
  export type PostGetPayload<
    ...
    ? Post  & {
    [P in TrueKeys<S['include']>]:
        P extends 'passages' ? Array < PassageGetPayload<S['include'][P]>>  :
        P extends 'laptops' ? Array < LaptopGetPayload<S['include'][P]>>  :
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'passages' ? Array < PassageGetPayload<S['select'][P]>>  :
        P extends 'laptops' ? Array < LaptopGetPayload<S['select'][P]>>  :
  ...
  export type ImageGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'defaultLaptops' ? Array < LaptopGetPayload<S['include'][P]>>  :
        P extends 'defaultPosts' ? Array < PostGetPayload<S['include'][P]>>  :
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'defaultLaptops' ? Array < LaptopGetPayload<S['select'][P]>>  :
        P extends 'defaultPosts' ? Array < PostGetPayload<S['select'][P]>>  :
  ...
  export type LaptopUncheckedCreateInput = {
    ...
    os?: OS
    priceMapId?: number | null
    discounts?: DiscountUncheckedCreateNestedManyWithoutLaptopsInput
    defaultImageId?: number | null
    purchases?: PurchaseUncheckedCreateNestedManyWithoutLaptopsInput
    posts?: PostUncheckedCreateNestedManyWithoutLaptopsInput
    comments?: CommentUncheckedCreateNestedManyWithoutLaptopInput
    images?: ImageUncheckedCreateNestedManyWithoutLaptopsInput
    videos?: VideoUncheckedCreateNestedManyWithoutLaptopsInput
    createdAt?: Date | string
    updatedAt?: Date | string
  }
  ...
  export type LaptopUncheckedUpdateInput = {
    ...
    discounts?: DiscountUncheckedUpdateManyWithoutLaptopsInput
    defaultImageId?: NullableIntFieldUpdateOperationsInput | number | null
    purchases?: PurchaseUncheckedUpdateManyWithoutLaptopsInput
    posts?: PostUncheckedUpdateManyWithoutLaptopsInput
    comments?: CommentUncheckedUpdateManyWithoutLaptopInput
    images?: ImageUncheckedUpdateManyWithoutLaptopsInput
    videos?: VideoUncheckedUpdateManyWithoutLaptopsInput
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
  }
  ...
  export type DiscountUncheckedCreateInput = {
    id?: number
    value?: number
    laptops?: LaptopUncheckedCreateNestedManyWithoutDiscountsInput
    createdAt?: Date | string
    updatedAt?: Date | string
  }
  ...
  export type DiscountUncheckedUpdateInput = {
    id?: IntFieldUpdateOperationsInput | number
    value?: FloatFieldUpdateOperationsInput | number
    laptops?: LaptopUncheckedUpdateManyWithoutDiscountsInput
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
  }
  ...
  export type PurchaseUncheckedCreateInput = {
    id?: number
    customerId: string
    laptops?: LaptopUncheckedCreateNestedManyWithoutPurchasesInput
    createdAt?: Date | string
    updatedAt?: Date | string
  }
  ...
  export type PurchaseUncheckedUpdateInput = {
    ...
    laptops?: LaptopUncheckedUpdateManyWithoutPurchasesInput
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
  }
  ...
  export type PostUncheckedCreateInput = {
    ...
    laptops?: LaptopUncheckedCreateNestedManyWithoutPostsInput
    authorId: string
    defaultImageId?: number | null
    images?: ImageUncheckedCreateNestedManyWithoutPostInput
    videos?: VideoUncheckedCreateNestedManyWithoutPostInput
    createdAt?: Date | string
    updatedAt?: Date | string
  }
  ...
  export type PostUncheckedUpdateInput = {
    ...
    laptops?: LaptopUncheckedUpdateManyWithoutPostsInput
    authorId?: StringFieldUpdateOperationsInput | string
    defaultImageId?: NullableIntFieldUpdateOperationsInput | number | null
    images?: ImageUncheckedUpdateManyWithoutPostInput
    videos?: VideoUncheckedUpdateManyWithoutPostInput
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
  }
  ...
  export type ImageUncheckedCreateInput = {
    ...
    mimeType?: MimeType
    data: Buffer
    laptops?: LaptopUncheckedCreateNestedManyWithoutImagesInput
    post?: PostUncheckedCreateNestedManyWithoutImagesInput
  ...
  export type ImageUncheckedUpdateInput = {
    ...
    mimeType?: EnumMimeTypeFieldUpdateOperationsInput | MimeType
    data?: BytesFieldUpdateOperationsInput | Buffer
    laptops?: LaptopUncheckedUpdateManyWithoutImagesInput
    post?: PostUncheckedUpdateManyWithoutImagesInput
  ...
  export type VideoUncheckedCreateInput = {
    ...
    title: string
    url: string
    laptops?: LaptopUncheckedCreateNestedManyWithoutVideosInput
    post?: PostUncheckedCreateNestedManyWithoutVideosInput
    createdAt?: Date | string
    updatedAt?: Date | string
  }
  ...
  export type VideoUncheckedUpdateInput = {
    ...
    title?: StringFieldUpdateOperationsInput | string
    url?: StringFieldUpdateOperationsInput | string
    laptops?: LaptopUncheckedUpdateManyWithoutVideosInput
    post?: PostUncheckedUpdateManyWithoutVideosInput
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
  }
  ...
  export type DiscountUncheckedCreateNestedManyWithoutLaptopsInput = {
    create?: XOR<Enumerable<DiscountCreateWithoutLaptopsInput>, Enumerable<DiscountUncheckedCreateWithoutLaptopsInput>>
    connectOrCreate?: Enumerable<DiscountCreateOrConnectWithoutLaptopsInput>
    connect?: Enumerable<DiscountWhereUniqueInput>
  }

  export type PurchaseUncheckedCreateNestedManyWithoutLaptopsInput = {
    create?: XOR<Enumerable<PurchaseCreateWithoutLaptopsInput>, Enumerable<PurchaseUncheckedCreateWithoutLaptopsInput>>
    connectOrCreate?: Enumerable<PurchaseCreateOrConnectWithoutLaptopsInput>
    connect?: Enumerable<PurchaseWhereUniqueInput>
  }

  export type PostUncheckedCreateNestedManyWithoutLaptopsInput = {
    create?: XOR<Enumerable<PostCreateWithoutLaptopsInput>, Enumerable<PostUncheckedCreateWithoutLaptopsInput>>
    connectOrCreate?: Enumerable<PostCreateOrConnectWithoutLaptopsInput>
    connect?: Enumerable<PostWhereUniqueInput>
  }
  ...
  export type ImageUncheckedCreateNestedManyWithoutLaptopsInput = {
    create?: XOR<Enumerable<ImageCreateWithoutLaptopsInput>, Enumerable<ImageUncheckedCreateWithoutLaptopsInput>>
    connectOrCreate?: Enumerable<ImageCreateOrConnectWithoutLaptopsInput>
    connect?: Enumerable<ImageWhereUniqueInput>
  }

  export type VideoUncheckedCreateNestedManyWithoutLaptopsInput = {
    create?: XOR<Enumerable<VideoCreateWithoutLaptopsInput>, Enumerable<VideoUncheckedCreateWithoutLaptopsInput>>
    connectOrCreate?: Enumerable<VideoCreateOrConnectWithoutLaptopsInput>
    connect?: Enumerable<VideoWhereUniqueInput>
  }
  ...
  export type DiscountUncheckedUpdateManyWithoutLaptopsInput = {
    create?: XOR<Enumerable<DiscountCreateWithoutLaptopsInput>, Enumerable<DiscountUncheckedCreateWithoutLaptopsInput>>
    connectOrCreate?: Enumerable<DiscountCreateOrConnectWithoutLaptopsInput>
    upsert?: Enumerable<DiscountUpsertWithWhereUniqueWithoutLaptopsInput>
    set?: Enumerable<DiscountWhereUniqueInput>
  ...
  export type PurchaseUncheckedUpdateManyWithoutLaptopsInput = {
    create?: XOR<Enumerable<PurchaseCreateWithoutLaptopsInput>, Enumerable<PurchaseUncheckedCreateWithoutLaptopsInput>>
    connectOrCreate?: Enumerable<PurchaseCreateOrConnectWithoutLaptopsInput>
    upsert?: Enumerable<PurchaseUpsertWithWhereUniqueWithoutLaptopsInput>
    set?: Enumerable<PurchaseWhereUniqueInput>
  ...
  export type PostUncheckedUpdateManyWithoutLaptopsInput = {
    create?: XOR<Enumerable<PostCreateWithoutLaptopsInput>, Enumerable<PostUncheckedCreateWithoutLaptopsInput>>
    connectOrCreate?: Enumerable<PostCreateOrConnectWithoutLaptopsInput>
    upsert?: Enumerable<PostUpsertWithWhereUniqueWithoutLaptopsInput>
    set?: Enumerable<PostWhereUniqueInput>
  ...
  export type ImageUncheckedUpdateManyWithoutLaptopsInput = {
    create?: XOR<Enumerable<ImageCreateWithoutLaptopsInput>, Enumerable<ImageUncheckedCreateWithoutLaptopsInput>>
    connectOrCreate?: Enumerable<ImageCreateOrConnectWithoutLaptopsInput>
    upsert?: Enumerable<ImageUpsertWithWhereUniqueWithoutLaptopsInput>
    set?: Enumerable<ImageWhereUniqueInput>
  ...
  export type VideoUncheckedUpdateManyWithoutLaptopsInput = {
    create?: XOR<Enumerable<VideoCreateWithoutLaptopsInput>, Enumerable<VideoUncheckedCreateWithoutLaptopsInput>>
    connectOrCreate?: Enumerable<VideoCreateOrConnectWithoutLaptopsInput>
    upsert?: Enumerable<VideoUpsertWithWhereUniqueWithoutLaptopsInput>
    set?: Enumerable<VideoWhereUniqueInput>
  ...
  export type LaptopUncheckedCreateNestedManyWithoutDiscountsInput = {
    create?: XOR<Enumerable<LaptopCreateWithoutDiscountsInput>, Enumerable<LaptopUncheckedCreateWithoutDiscountsInput>>
    connectOrCreate?: Enumerable<LaptopCreateOrConnectWithoutDiscountsInput>
    connect?: Enumerable<LaptopWhereUniqueInput>
  }
  ...
  export type LaptopUncheckedUpdateManyWithoutDiscountsInput = {
    create?: XOR<Enumerable<LaptopCreateWithoutDiscountsInput>, Enumerable<LaptopUncheckedCreateWithoutDiscountsInput>>
    connectOrCreate?: Enumerable<LaptopCreateOrConnectWithoutDiscountsInput>
    upsert?: Enumerable<LaptopUpsertWithWhereUniqueWithoutDiscountsInput>
    set?: Enumerable<LaptopWhereUniqueInput>
  ...
  export type LaptopUncheckedCreateNestedManyWithoutPurchasesInput = {
    create?: XOR<Enumerable<LaptopCreateWithoutPurchasesInput>, Enumerable<LaptopUncheckedCreateWithoutPurchasesInput>>
    connectOrCreate?: Enumerable<LaptopCreateOrConnectWithoutPurchasesInput>
    connect?: Enumerable<LaptopWhereUniqueInput>
  }
  ...
  export type LaptopUncheckedUpdateManyWithoutPurchasesInput = {
    create?: XOR<Enumerable<LaptopCreateWithoutPurchasesInput>, Enumerable<LaptopUncheckedCreateWithoutPurchasesInput>>
    connectOrCreate?: Enumerable<LaptopCreateOrConnectWithoutPurchasesInput>
    upsert?: Enumerable<LaptopUpsertWithWhereUniqueWithoutPurchasesInput>
    set?: Enumerable<LaptopWhereUniqueInput>
  ...
  export type LaptopUncheckedCreateNestedManyWithoutPostsInput = {
    create?: XOR<Enumerable<LaptopCreateWithoutPostsInput>, Enumerable<LaptopUncheckedCreateWithoutPostsInput>>
    connectOrCreate?: Enumerable<LaptopCreateOrConnectWithoutPostsInput>
    connect?: Enumerable<LaptopWhereUniqueInput>
  }
  ...
  export type VideoUncheckedCreateNestedManyWithoutPostInput = {
    create?: XOR<Enumerable<VideoCreateWithoutPostInput>, Enumerable<VideoUncheckedCreateWithoutPostInput>>
    connectOrCreate?: Enumerable<VideoCreateOrConnectWithoutPostInput>
    connect?: Enumerable<VideoWhereUniqueInput>
  }
  ...
  export type LaptopUncheckedUpdateManyWithoutPostsInput = {
    create?: XOR<Enumerable<LaptopCreateWithoutPostsInput>, Enumerable<LaptopUncheckedCreateWithoutPostsInput>>
    connectOrCreate?: Enumerable<LaptopCreateOrConnectWithoutPostsInput>
    upsert?: Enumerable<LaptopUpsertWithWhereUniqueWithoutPostsInput>
    set?: Enumerable<LaptopWhereUniqueInput>
  ...
  export type VideoUncheckedUpdateManyWithoutPostInput = {
    create?: XOR<Enumerable<VideoCreateWithoutPostInput>, Enumerable<VideoUncheckedCreateWithoutPostInput>>
    connectOrCreate?: Enumerable<VideoCreateOrConnectWithoutPostInput>
    upsert?: Enumerable<VideoUpsertWithWhereUniqueWithoutPostInput>
    set?: Enumerable<VideoWhereUniqueInput>
  ...
  export type LaptopUncheckedCreateNestedManyWithoutImagesInput = {
    create?: XOR<Enumerable<LaptopCreateWithoutImagesInput>, Enumerable<LaptopUncheckedCreateWithoutImagesInput>>
    connectOrCreate?: Enumerable<LaptopCreateOrConnectWithoutImagesInput>
    connect?: Enumerable<LaptopWhereUniqueInput>
  }
  ...
  export type LaptopUncheckedUpdateManyWithoutImagesInput = {
    create?: XOR<Enumerable<LaptopCreateWithoutImagesInput>, Enumerable<LaptopUncheckedCreateWithoutImagesInput>>
    connectOrCreate?: Enumerable<LaptopCreateOrConnectWithoutImagesInput>
    upsert?: Enumerable<LaptopUpsertWithWhereUniqueWithoutImagesInput>
    set?: Enumerable<LaptopWhereUniqueInput>
  ...
  export type LaptopUncheckedCreateNestedManyWithoutVideosInput = {
    create?: XOR<Enumerable<LaptopCreateWithoutVideosInput>, Enumerable<LaptopUncheckedCreateWithoutVideosInput>>
    connectOrCreate?: Enumerable<LaptopCreateOrConnectWithoutVideosInput>
    connect?: Enumerable<LaptopWhereUniqueInput>
  }
  ...
  export type LaptopUncheckedUpdateManyWithoutVideosInput = {
    create?: XOR<Enumerable<LaptopCreateWithoutVideosInput>, Enumerable<LaptopUncheckedCreateWithoutVideosInput>>
    connectOrCreate?: Enumerable<LaptopCreateOrConnectWithoutVideosInput>
    upsert?: Enumerable<LaptopUpsertWithWhereUniqueWithoutVideosInput>
    set?: Enumerable<LaptopWhereUniqueInput>
